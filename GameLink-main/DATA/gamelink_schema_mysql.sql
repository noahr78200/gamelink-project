-- ========================
-- SCHEMA GAMELINK - MySQL/MariaDB
-- ========================

-- Suppression des tables si elles existent (ordre inversé pour les dépendances)
DROP TABLE IF EXISTS joueur_badge;
...
DROP TABLE IF EXISTS statistique_jeu;
DROP TABLE IF EXISTS avis;
DROP TABLE IF EXISTS playlist_jeu;
